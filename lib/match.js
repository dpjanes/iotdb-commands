...
var match = function(paramd, done) {
    ...
    // extensions - basically an over ride
    var xds = _prepare_items(vocabulary.extensions(paramd.requestd));

    // thing definitions - what to match
    var tds = _prepare_items(vocabulary.things(paramd.requestd.thing));

    // action and query definitions - what to do
    var ads = _prepare_items(vocabulary.actions(paramd.requestd.action));
    var qds = _prepare_items(vocabulary.querys(paramd.requestd.query));
    ads = ads.concat(qds);
    ...
    var _level_2 = function(thingd) {
        ...
        if (match_ad.do) {
             ...
             */
            var dod = match_ad.do;
            var dvalue = match_ad.do["@value"] || null;
        ...
        /**
         *  XXX - this needs to be cleaned up massively
         */
        /*
