...
const match = function(paramd, done) {
    ...
    if (paramd.requestd.argument) {
        paramd.requestd.argument = normalize.word(paramd.requestd.argument);
    }
    ...
    const ads = 
        ...
        .filter(ad => !ad.argument || (ad.argument === paramd.requestd.argument) || (ad.argument === "*"));
    ...
    const _level_2 = function(thingd) {
        ...
        if (match_ad.do) {
            do {
                ...
                if (match_ad.argument === "*") {
                    dvalue = paramd.requestd.argument;
